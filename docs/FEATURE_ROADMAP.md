...
See `docs/NOTIFICATIONS_PLAN.md` for the full breakdown. Both consent follow-ups (`F-Onboarding-Consent`, `F-First-Launch-Prompt`) are shipped; the only remaining notification follow-up is `F-Multi-Reminder`.
