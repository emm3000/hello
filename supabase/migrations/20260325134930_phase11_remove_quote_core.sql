...
where app_account_id in (select app_account_id from public.sync_operation where entity_type = 'quote')
  and op_id in (select op_id from public.sync_operation where entity_type = 'quote');
